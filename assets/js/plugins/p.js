...
var customvar = {
  ...
  videoDomain: predomain
    ? "https://workdrive.nimbuspop.com/zvideo/"
    : "https://workdrive.zohoexternal.com/zvideo/",
  IfStatementDomainForVideo: predomain
    ? "workdrive.nimbuspop.com"
    : "www.zoho.com/zvideo/",
  ...
  productTermList: {
    ...
    marketingautomation:
      "https://www.zoho." +
      domainOne +
      "/marketingautomation/terms-of-service.html",
      ...
      t.forEach((e, t) => {
        $(e).each(function (e, t) {
          ...
          if (a != "" && typeof a != "undefined") {
            ...
            if (
              customvar.pagesListData.search(a) > -1 &&
              !a.includes("/" + currentUrlLang + "/")
            ) {
              $(t).attr("href", "/" + currentUrlLang + $(t).attr("href"));
            }
          }
  ...
  getPrivacyLink: function (e, t, a, o) {
    ...
    if ($(".globalstatecode").length > 0 || t) {
      ...
      if (y) {
        if (
          !customvar.usstates.includes(y) ||
          !customvar.instates.includes(y)
        ) {
    ...
    if (e != "") {
      for (var t = 0; t < e.length; t++) {
        if (e.indexOf(customvar.instates[1] > -1) && t == 0) {
          this._val +=
            '<option value="select your state">' + e[t] + "</option>";
        } else {
          this._val +=
            '<option value="' + e[t].toLowerCase() + '">' + e[t] + "</option>";
        }
      }
      if (arguments.length > 0) {
  ...
  dcselected: function (e) {
    if (
      e == "US" ||
      (e == "IN" && stateupdate.indexOf(customvar.productName) > -1)
    ) {
      if ($(".za-globalstate-signup").length > 0) {
        if (
          $(".za-globalstate-signup option").eq(0).val() == "" ||
      ...
      if ($(".zrlink").length > 0 && e == "US") {
        if ($(".za-globalstate-signup").val().toLowerCase() == "california") {
          if (
            ...
            $(".zrlink").attr(
              "href",
              "https://www.zoho." + domainOne + "/us-ca/privacy.html",
            );
          }
        } else {
          if (
            ...
            $(".zrlink").attr(
              "href",
              "https://www.zoho." + domainOne + "/privacy.html",
            );
          }
        }
      }
  ...
  loadlangxml: function () {
    ...
    e.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        if (
          (e.indexOf("index") > 0 && e.indexOf("index1") < 0) ||
          e.indexOf("index1") > 0
        ) {
          e = e.split("index")[0];
        }
        ...
        for (var n = 0; n < r[0].length; n++) {
          if (
            ...
            var p =
              window.location.origin + "/" + r[0][n].split("zoho.com/")[1] + m;
            if (r[1][n] == "zh-hans") {
              p = r[0][n] + m;
            }
            if (customvar.outproduct.indexOf(customvar.productName) > -1) {
              if (window.location.host.includes("prewww")) {
                ...
                p =
                  window.location.origin +
                  "/" +
                  r[0][n].split(window.location.host + "/")[1] +
                  m;
              }
            }
            if (r[1][n] == d) {
    ...
    if (window.location.host == _preZ) {
      if (customvar.productName == "community") {
        ...
        e.open(
          "GET",
          window.location.origin + "/crm/" + t + a + "sitemap.xml",
          true,
        );
      } else if (window.location.href.includes("desk/serviceplus/")) {
        e.open(
          "GET",
          window.location.origin + "/desk/" + t + a + "sitemap.xml",
          true,
        );
      } else {
        e.open("GET", "https://" + _preZ + "/" + t + a + "sitemap.xml", true);
      ...
      if (
        ...
        e.open(
          "GET",
          window.location.origin + "/" + t + a + "sitemap.xml",
          true,
        );
      }
    } else {
  ...
  findMailToReplace: function (e) {
    if (
      $('a[href="mailto:' + e.global + '"]').length > 0 &&
      typeof e[dcdomainOne] != "undefined"
    ) {
      $('a[href="mailto:' + e.global + '"]').html(e[dcdomainOne]);
      $('a[href="mailto:' + e.global + '"]').attr(
        "href",
        "mailto:" + e[dcdomainOne],
      );
    }
  },
  dcadded: function (a) {
      ...
      if (!customvar.isBlogPage) {
        if (_preZ == window.location.hostname) {
          ...
          $.getScript(
            "https://www.zoho." +
              domainOne +
              "/sites/zweb/js/common/dynamicemail.js",
          );
        }
      }
    }
...
var addDynamicScript = (function () {
  ...
  return function (o) {
    ...
    if (
      document.querySelectorAll('script[src*="' + n + '"]').length === 0 &&
      !i[n].needToLoad
    ) {
      i[n].needToLoad = true;
    }
...
var zghPhone =
  '<div class="zgh-phone"><a href="tel:+18339573953">(+1 833-957-3953)</a></div>';
if ($("body").hasClass("lang-rtl")) {
  zghPhone =
    '<div class="zgh-phone"><a href="tel:+18339573953">&lrm;(+1 833-957-3953)</a></div>';
}
var zghPhonePages = ["one", "crm", "desk", "assist", "workplace", "creator"];
var zghPhonePagesPath = [
  `${langsrc}`,
  `${langsrc}all-products.html`,
  `${langsrc}customers.html`,
];
if (
  currentUrlLang !== "jp" &&
  CountryCode == "CA" &&
  !customvar.outproduct.includes(customvar.productName) &&
  (zghPhonePages.includes(customvar.productName) ||
    zghPhonePagesPath.includes(customvar.pathname))
) {
  zghUtil =
        ...
        if ($("body").attr("data-domain") == "oweb") {
          if (customvar.outproduct.indexOf(customvar.productName) > -1) {
            $.getScript(
              "https://www.zoho." +
                domainOne +
                "/sites/zweb/js/common/prod_menu.js",
            );
          } else {
            $.getScript(
...
customvar.changeiframeToWorkdrive = function () {
  ...
  e.forEach(function (e) {
    ...
    if (
      a?.includes("workdrive.zohoexternal.com") ||
      a?.includes("www.zoho.com/zvideo/")
    ) {
    ...
    if (
      a?.includes("workdrive.zohoexternal.com") ||
      a?.includes(customvar.IfStatementDomainForVideo)
    ) {
...
customvar.checkVimeoToWorkdrive = function (e) {
  if (
    !workdriveVideoExceptions.includes(customvar.productName) &&
    currentUrlLang != "jp" &&
    isWorkdriveException
  ) {
    const t = e.getAttribute("data-video").split("?")[0];
    const a = t.split("?")[0];
    const o = a.replace(
...
const workdriveVideoExceptions =
  _preZ == window.location.hostname ? [] : ["zohobigin"];
const workdriveVideoExceptionsPages = [
  "com/customers.html",
  "com/search-results.html",
];
const isWorkdriveException = !workdriveVideoExceptionsPages.some((e) =>
  _lhref.includes(e),
);
jQuery(document).ready(function () {
  ...
  jQuery(".zoho-home-page .scroll-down .scrolldown-arrow").click(function () {
    jQuery("body").animate(
      {
        scrollTop:
          jQuery(".pane-home-page-view-panel-pane-1").offset().top - t + 55,
      },
      1e3,
    );
  });
  ...
  oe(document).ready(function (U) {
    ...
    if (t) {
      if (dcenabled && nondc) {
        ...
        (customvar.domainArr[0]?.push("sa"),
          customvar.domainArr[2]?.push("zoho.sa"));
        for (var i = 0; i < customvar.domainList[0].length; i++) {
          ...
          oe(e).on("load", function () {
            ...
            if (
              o == oe(".infoload").length &&
              customvar.domainList[1].length == 0
            ) {
              var t = customvar.dcObj;
              dcdomainOne = "com";
              for (var a in t) {
    ...
    if (customvar.productName == "arattai") {
      ...
      oe(E).on("load", function () {
        if (typeof zohouser.DC_INFO != "undefined") {
          ...
          hidelogin =
            customvar.dcObj["in"].notavailable.indexOf(customvar.productName) >
            -1
              ? 1
              : hidelogin;
        }
    ...
    oe(window).scroll(function () {
      ...
      if (
        oe(".zlang-container").children(".zlang-container-inner").length > 0
      ) {
        oe(".zlang-container")
    ...
    oe(".menu-icon").click(function () {
      ...
      if (x == false) {
        ...
        setTimeout(function () {
          ...
          var e =
            parseInt(window.innerHeight) - parseInt(oe(".header").height());
    ...
    oe("body").click(function (e) {
      ...
      if (
        productName == "mail" &&
        oe(".signup-box form").css("display") == "none"
      ) {
        t = false;
      } else if (
        _lhref.indexOf("/creator/apps/") > 0 ||
        oe(e.target).hasClass("scrollstop")
      ) {
        t = false;
      }
      var a = "",
      ...
      if (e.target.parentNode) {
        e.target.parentNode.parentNode != null
          ? (n = e.target.parentNode.parentNode.className)
          : "";
        e.target.parentNode.className != null
          ? (o = e.target.parentNode.className)
          : "";
      }
      ...
      if (window.location.href.indexOf("crm/what-is-crm.html") < 0 && t) {
        if (
          ...
          if (
            oe(".signup-box #czone-wallet").length > 0 &&
            oe(".form-wrap .creditelm").length > 0
          ) {
            e.preventDefault();
            if (getusername) {
      ...
      if (e.target.className == "menu") {
        ...
        oe(".product-nav-links .menu").css({
          height:
            window.innerHeight - oe("#mini-panel-product_menu").outerHeight(),
        });
        if (k == false) {
      ...
      if (n == "userinfo-details") {
        ...
        if (getWidth > 285) {
          oe(".userinfo-details.zoho-expand").css({
            width: getWidth + 10,
            height: "135px",
          });
        }
    ...
    oe(window).resize(function () {
      ...
      if (oe(window).outerWidth() <= 767) {
        ...
        oe(".product-nav-links .menu .featured-apps-part").css(
          "display",
          "block",
        );
        ...
        if (
          ...
          var e =
            ...
            oe(".header .zlang-container").html() +
            "</div>";
    ...
    function H() {
      if (jQuery("body").hasClass("og-context-node-3434")) {
        if (jQuery("body").hasClass("node-type-product-help")) {
          jQuery(".menu-panel .zoho-parent-wrapper .hasChild ").each(
            function (e, t) {
              if (e == 0) {
                var a = jQuery(this)
      ...
      if (getAllField.length != 0) {
        ...
        if (customvar.productName != "recruit") {
          setTimeout(function () {
            ...
            e.length > 1
              ? e.eq(1).addClass("focusin").focus()
              : e.eq(0).addClass("focusin").focus();
          }, 2e3);
        }
      }
    }
    ...
    function ee() {
      ...
      if (!getusername) {
        ...
        if (typeof t != "undefined" && typeof t != "") {
          var a = "";
          currentLang != ""
            ? (a = "service_language=" + currentLang + "&")
            : (a = "");
          e =
      ...
      if (!customvar.customclean) {
        if (window.innerWidth > 992 && window.innerHeight < 800) {
          if (oe(".testimonial-content").length > 0) {
            ...
            oe(".testimonial-content").css(
              "margin-top",
              (window.innerHeight - 20 - e) / 2,
            );
          }
        }
        ...
        if (getusername) {
          ...
          if (
            oe(".zh-access").length > 0 &&
            oe("body").hasClass("node-type-zoho-home")
          ) {
            oe(".zh-access").attr(
              "href",
        ...
        if (!getusername) {
          ...
          if (i.indexOf(productName) < 0) {
            ...
            productName == "home"
              ? (r = r.split("/home")[0] + r.split("/home")[1])
              : "";
            productName == "mail"
              ? (r = langsrc + "mail/zohomail-pricing.html")
              : "";
          }
        ...
        if (getusername) {
          ...
          if (oe(".loggedin-userinfo").length > 0) {
            ...
            if (oe(".access-apps").length < 1) {
              ...
              oe(".loggedin-userinfo .access-apps").html(
          ...
          var g = setInterval(function () {
            if (oe(".zw-product-header .zgh-accounts").length > 0) {
              ...
              oe(".zgh-userAccess a").attr(
                "href",
                oe(".act-btn.cta-btn").attr("href"),
              );
          ...
          if (typeof customvar.nonlogged != "undefined") {
            ...
            var g = setInterval(function () {
              if (oe(".zlogin-menu").length > 0) {
                oe(".zlogin-menu a").attr(
                  "href",
                  oe(".zgh-login").attr("href"),
                );
                clearInterval(g);
              }
              if (f > 20) {
          ...
          if (
            ...
            oe(".product-header-top .zgh-signup").length
          ) {
            if (
              !oe(".product-header-top .zgh-signup")
                .attr("href")
                .includes(customvar.productName)
            ) {
              oe(".product-header-top .zgh-signup").attr(
                "href",
                langsrc + "signup.html",
              );
            }
          ...
          oe(".product-header-top .zgh-accounts .zgh-login").css(
            "display",
            "none",
          );
        }
...
$(window).on("load", function () {
  ...
  if (customvar.productName != "crm") {
    for (var t = 0; t < e.length; t++) {
      if (
        typeof $(".zcpopup-controller, .popup-controller")
          .eq(t)
          .attr("data-video") != "undefined"
      ) {
      ...
      if ($(".zgh-localBox ul").html() != "") {
        if ($(".zgh-localBox ul li").length > 0) {
          ...
          if (
            ...
            isMobile &&
            $(".ZF-dlsel .zlang-container").length
          ) {
            $(".ZF-dlsel .zlang-container").addClass(
              "zwc-footer-lang-drop-safari",
            );
          }
          $(".zlang-container-inner li a").on("blur", function (e) {
            ...
            let a = t.length;
            if (
              (t[a - 1] == e.target || t[0] == e.target) &&
              ![...t].includes(e.relatedTarget)
            ) {
...
function setValidationAttr() {
  $(".signup-box .field-error input, .signup-box .field-error select").each(
    function () {
      const e = $(this).is(":visible");
      if (e) {
        $(this).attr("aria-invalid", true);
...
jQuery(document).on("click", ".show-links-btn", function () {
  ...
  const e = document.querySelector(
    ".zw-promo-bottom .quick-connect-links-wrap .quick-connect-links",
  );
      ...
      if (
        ...
        if (customvar.lsoinfo("latinNavigate") == "") {
          ...
          $(".lbanner .langTxt").on("click", function () {
            ...
            window.location =
              t + e + "zredirect=f&lb=" + currentUrlLang + "&zsrc=bheader";
          });
    ...
    if (
      ...
      o.addEventListener("click", function () {
        ...
        window.location.href = encodeURI(
          i + e + "zredirect=f&lb=" + currentUrlLang + "&zsrc=bheader",
        );
      });
...
$(document).ready(function (Z) {
  ...
  if (
    langArr.indexOf(currentUrlLang) > -1 &&
    global_getUrlParam("pages-list") == ""
  ) {
    var e = $("body a");
    var T = [
      "mail",
      ...
      if (
        ...
        var a = e.eq(t).attr("href").split("/").indexOf("help") < 0,
          ...
          l =
            "https://www.zoho." +
              domainOne +
              "/assist/lp/demo-registration.html?src=pricing-faq" !=
          ...
          k =
            e
              ...
              .attr("href")
              .indexOf(
                "https://www.zoho." + domainOne + "/campaigns/contact-us.html",
              ) < 0,
          x =
            e
              .eq(t)
              ...
              .indexOf(
                "https://www.zoho." +
                  domainOne +
                  "/survey/education-discount.html",
              ) < 0,
          O =
            e
              .eq(t)
              .attr("href")
              .indexOf(
                "https://www.zoho." + domainOne + "/developer/signup.html",
              ) < 0,
          _ = e.eq(t).attr("href").indexOf("reports/onpremise/eula.html") < 0,
          S =
            e.eq(t).attr("href").indexOf("reports/onpremise/get-quote.html") <
            0,
          ...
          q =
            e
              ...
              .attr("href")
              .indexOf(
                "https://www.zoho." + domainOne + "/teamdrive/contact.html",
              ) < 0,
          M =
            e
              .eq(t)
              .attr("href")
              .indexOf(
                "https://www.zoho." + domainOne + "/workdrive/contact.html",
              ) < 0,
          I = e.eq(t).attr("href").indexOf("webinars.html") < 0,
          R =
            e.eq(t).attr("href").indexOf("analytics/onpremise/get-quote.html") <
            0,
        ...
        if (
          ...
          if (e.eq(t).attr("href").split("/")[1] == productName) {
            ...
            if (
              allProductlowerCase.indexOf(e.eq(t).attr("href").split("/")[3]) >
              -1
            ) {
              var U = encodeURI(
                "https://www.zoho." +
            ...
            currentUrlLang == "ar" &&
            e.eq(t).attr("href") == "/compliance.html"
          ) {
            var U = encodeURI("/" + currentUrlLang + e.eq(t).attr("href"));
            e.eq(t).attr("href", U);
          }
        ...
        if (
          e.eq(t).attr("href").indexOf("help/") > -1 ||
          e.eq(t).attr("href").indexOf("blog") > -1
        ) {
          if (currentUrlLang != "jp") {
...
const vimeoPopup = (function () {
  ...
  class e {
    ...
    play(e) {
      ...
      if (
        e.getAttribute("data-video").includes("https://player.vimeo.com/video/")
      ) {
    ...
    appendVideoIframe() {
      ...
      let t = "";
      if (
        e.includes("workdrive.zohoexternal.com") ||
        e.includes(customvar.IfStatementDomainForVideo)
      ) {
        t += e.includes("?") ? "&" : "?";
    ...
    keyClose(t) {
      if (t.key === "Tab" || t.keyCode === 9) {
        let e = this.popupWrap.querySelectorAll(
          ...
          if (predomain) {
            if (window.location.hostname.includes(_prewww)) {
              ...
              if (global_getUrlParam("header-test")) {
                newzchf.src =
                  customvar.ocmsprelink +
                  "/sites/zweb/js/common/zc-headerfooter-test.js";
              } else {
                newzchf.src =
                  customvar.ocmsprelink +
            ...
            if (
              window.location.hostname == _preZ ||
              $("body").hasClass("zwc-creative-zmt-editor")
            ) {
              newzchf.src = "/sites/zweb/js/common/zc-headerfooter-v2.js";
            } else {
              newzchf.src =
...
function getLazSrc(e, t, a, o, n, i) {
  if (
    typeof e.attr("data-screen") !== typeof undefined &&
    e.attr("data-screen") !== false
  ) {
...
function setLazImgSrc(e, t, a, o, n) {
  if (t == 1) {
    for (g = 0; g < a.length; g++) {
      var i = $(a[g]);
      if (
        typeof i.attr("data-srcset") !== typeof undefined &&
        i.attr("data-srcset") !== false
      ) {
  ...
  if (r.length) {
    for (a = 0; a < r.length; a++) {
      ...
      if (thatObjOff >= 1 || objIsHid == "true" || objIsHid == "child") {
        if (
          (i == 1 && thatObjOff <= n.height() * 2) ||
          (i == 0 && o + n.height() * 2 >= thatObjOff)
        ) {
        ...
        if (
          ...
          if (s != "") {
            if (s.length <= 2 && s <= defColLineCount) {
              ...
              s.length >= 3 &&
              (s.endsWith("top") || s.endsWith("bottom"))
            ) {
              ...
              if (
                n == 1 ||
                (n == 0 && o + (t / zElmOffsetTotalRow) * zElmOffsetRow >= u)
              ) {
                zScrollOnPos(r, l);
              }
                ...
                if (zElmOffsetRow.split("/").length == 2) {
                  ...
                  if (zElmOffsetRes.split("-").length == 1) {
                    if (
                      ...
                      (n == 1 ||
                        (n == 0 &&
                          o + (t / defColLineCount) * zElmOffsetRow >= u))
                    ) {
                      zScrollOnPos(r, l);
                    }
                  } else {
...
customvar.mandatestart = function () {
  for (var e = 0; e <= $(".czone-dc input").length; e++) {
    if (
      $(".czone-dc .signupcontainer input").eq(e).attr("mandate") != "false"
    ) {
      if (
      ...
      if ($("#czone-home").length > 0) {
        if (
          ...
          var t = $(".czone-dc .signupcontainer input")
            .eq(e)
            .attr("placeholder");
          if (t.indexOf("*") < 0) {
            $(".czone-dc .signupcontainer input")
...
function z_add_account_script_common() {
  ...
  customvar.zDomainHandling();
  if (
    $(".signup-box #czone-wallet").length > 0 ||
    $(".signup-box").hasClass("param_based_wallet")
  ) {
    if (
    ...
    if (customvar.OTP_based()) {
      ...
      if (global_getValParam("mode", t.src) == "") {
        ...
        if (global_getValParam("mode", t.src) != "24") {
          t.src = t.src
            .split("mode=" + global_getValParam("mode", t.src))
            .join("mode=24");
        }
      }
    } else {
  ...
  (function () {
    if (
      ...
      if (!$(".mobile-container #mobile").length) {
        $(".signupcontainer .za-captcha-container").before(
          customvar.signupflow["dialcodecontactnumber"],
        );
      } else {
      ...
      if (
        $(".czone-dc #password").attr("placeholder") == "" ||
        ...
        if (
          customvar.productName == "catalyst" &&
          $(".czone-dc").attr("id") == "czone-signup"
        ) {
        } else {
          $(".mobile-container .placeholder")?.html("");
          $(".mobile-container #mobile")?.attr(
            "placeholder",
  ...
  zr_script = t;
  $(".signup-box #czone-home input, .signup-box #czone-wallet input").each(
    function () {
      if (
...
function statehandling(e) {
  ...
  if (e == "CA") {
    for (var a = 0; a < customvar.castates.length; a++) {
      t +=
        '<option value="' +
        customvar.castates[a].toLowerCase() +
        '">' +
        customvar.castates[a] +
        "</option>";
    }
  } else {
    for (var a = 0; a < customvar.usstates.length; a++) {
      t +=
        '<option value="' +
        customvar.usstates[a].toLowerCase() +
        '">' +
        customvar.usstates[a] +
        "</option>";
    }
  }
...
$(document).on(
  "keyup",
  ".signup-box .za-remobile-container #confirmMobile",
  function () {
    if (
      typeof getValidMobileNumber === "function" &&
      $("#confirmMobile").length
    ) {
...
function addsignup(e) {
  ...
  customvar.signupflow = {
    ...
    username:
      ...
      Drupal.t("Email Address") +
      '" aria-label="' +
      (customvar.absurl.includes("/mail/msignup.html")
        ? Drupal.t("Username")
        : Drupal.t("Email Address")) +
  ...
  for (var t in customvar.signupObj) {
    ...
    var o =
      typeof customvar.signupObj[t].required != "undefined"
        ...
        : true;
    if (
      ["customelement", "customelementone", "customelementtwo"].includes(t) &&
      customvar.signupObj[t] == ""
    ) {
      o = false;
    }
    if (typeof customvar.signupflow[a] != "undefined" && o) {
      ...
      if (
        ...
        customvar?.singleFieldSingupFlow[a] &&
        !customvar.OTP_based()
      ) {
      ...
      for (var n in customvar.signupObj[t]) {
        ...
        if (r == "nameattr") {
          ...
          if (
            customvar.signupObj[t][n] == "mobile" &&
          ...
          if (r == "mandatory-dc") {
            if (
              customvar.signupObj[t][n].split(",").indexOf(dcdomainOne) > -1
            ) {
...
customvar.signupEditionHandler = function (e, t) {
  if (e.target.id == "personal") {
    var a = $('.signupcontainer [name="signup_edition"]#personal').attr(
      "checked",
    );
    ...
    var o = $('.signupcontainer [name="signup_edition"]#business').attr(
      "checked",
    );
    ...
    var o = $('.signupcontainer [name="signup_edition"]#agencies').attr(
      "checked",
    );
  ...
  if ($('.signup-box [name="signup_edition"]:checked').length) {
    ...
    $('.signup-box .signupcontainer [name="x_accountType"]:checked').length
  ) {
    if (typeof customvar.accounttypeoptions != "undefined") {
      customvar.accounttypeoptions(e.target.id);
    }
    $(
      '.signup-box .signupcontainer [id="' + e.target.id + '"]:checked',
    ).focus();
  } else if (
    $('.signup-box .signupcontainer [name="x_accounttype"]:checked').length
  ) {
...
function onSignupReady() {
  ...
  if (global_getUrlParam("ismobilesignup") !== "") {
    $(".za-tos-container .czone-signup-term, .za-tos-container .zrlink").each(
      function () {
  ...
  if (
    customvar.recruitBannedDomainsPages &&
    customvar.recruitBannedDomainsPages.includes(window.location.pathname)
  ) {
  ...
  if (customvar?.signupObj?.email?.banneddomains) {
    $.validator.addMethod("email", function (t, e) {
      const a = customvar.signupObj.email.banneddomains.some((e) =>
        t.includes(e),
      );
      if (a) {
        return Validator.setJQueryMessage(
  ...
  $.validator.addMethod("isValidPhone", function (e, t) {
    ...
    if (e != "") {
      if (!n.test(e)) {
        if (
          $(".phone_countrycode")?.val() == "+55" &&
          customvar.whatsAppFormatBrazil
        ) {
          if (!o.test(e)) {
            return false;
          }
  ...
  $.validator.addMethod("numbersOnly", function (e, t) {
    ...
    if (e) {
      if (!a.test(e)) {
        ...
        return customvar.productName == "one" && CountryCode == "CA" && e < 1
          ? false
          : true;
      }
    } else {
      return customvar.productName == "one" &&
        CountryCode == "CA" &&
        e.length < 1
        ? false
        : true;
    ...
    oncomplete: function (e) {
      ...
      if ($("#mobileotp").length > 0) {
        ...
        if ($("#mobileotp").html().indexOf("@") > 0) {
          ...
          $(".signup-box .signupotpcontainer #otpfield").attr(
            "aria-label",
            customvar.enterotpemail,
          );
          $(".otpmobile .change").attr(
            "aria-label",
            customvar.changeme + " " + customvar.email,
          );
        } else {
          ...
          $(".otpmobile .change").attr(
            "aria-label",
            customvar.changeme + " " + customvar.phoneNumber,
          );
        }
      }
    },
...
$(window).on("load", () => {
  ...
  if (
    $(".zw-product-header:visible").length &&
    $(".zw-product-header > div").children().length
  ) {
    let e = $(
...
function zwc_modalFocusControl(a) {
  if (!(a instanceof HTMLElement))
    return console.warn("Invalid modal element.");
  const e = { attributes: true };
  const t = a.querySelector(".zc-modal-close-btn");
  if (!t)
    return console.warn(
      "Close button (.modal-close-btn) not found inside modal.",
    );
...
function zwc_ChangeBookingsFormLink() {
  ...
  const e = document.querySelectorAll(
    `iframe[src^='https://${t}'], a[href^='https://${t}']`,
  );
  e.forEach((e) => {
    zwc_UpdateDynamicLink(e, t, a);
  });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const t = [
    `www.zoho.${domainOne}`,
    _preZ,
    `catalyst.zoho.${domainOne}`,
    `community.zoho.${domainOne}`,
  ];
