 ...
 */
{
  ...
  class HoverImgFx12 {
    constructor(el) {
      ...
      this.DOM.revealDecos = [
        ...this.DOM.reveal.querySelectorAll(".rts-img-reveal-wrapper__deco"),
      ];
  ...
  class HoverImgFx13 {
    constructor(el) {
      ...
      this.DOM.el.appendChild(this.DOM.reveal);
      this.DOM.revealImgs = [
        ...this.DOM.reveal.querySelectorAll(".rts-img-reveal-wrapper__img"),
      ];
      charming(this.DOM.el);
      this.DOM.letters = [...this.DOM.el.querySelectorAll("span")];
      this.initEvents();
  ...
  class HoverImgFx20 {
    constructor(el) {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        inner +=
          i === this.totalImages - 1
            ? `<div class="rts-img-reveal-wrapper__img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"><span class="rts-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle : ""}</span> <h3 class="rts-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title : ""}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc : ""}</p></div>`
  ...
  class HoverImgFx22 {
    constructor(el) {
      ...
      this.DOM.el.appendChild(this.DOM.reveal);
      this.DOM.revealImg = this.DOM.reveal.querySelector(
        ".rts-img-reveal-wrapper__img",
      );
  ...
  [
    ...document.querySelectorAll(
      '[data-fx="pt1"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="pt1"]',
    ),
  ].forEach((link) => new HoverPTCard1(link));
  [
    ...document.querySelectorAll(
      '[data-fx="1"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="1"]',
    ),
  ].forEach((link) => new HoverImgFx1(link));
  [
    ...document.querySelectorAll(
      '[data-fx="2"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="2"]',
    ),
  ].forEach((link) => new HoverImgFx2(link));
  [
    ...document.querySelectorAll(
      '[data-fx="3"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="3"]',
    ),
  ].forEach((link) => new HoverImgFx3(link));
  [
    ...document.querySelectorAll(
      '[data-fx="4"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="4"]',
    ),
  ].forEach((link) => new HoverImgFx4(link));
  [
    ...document.querySelectorAll(
      '[data-fx="5"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="5"]',
    ),
  ].forEach((link) => new HoverImgFx5(link));
  [
    ...document.querySelectorAll(
      '[data-fx="6"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="6"]',
    ),
  ].forEach((link) => new HoverImgFx6(link));
  [
    ...document.querySelectorAll(
      '[data-fx="7"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="7"]',
    ),
  ].forEach((link) => new HoverImgFx7(link));
  [
    ...document.querySelectorAll(
      '[data-fx="8"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="8"]',
    ),
  ].forEach((link) => new HoverImgFx8(link));
  [
    ...document.querySelectorAll(
      '[data-fx="9"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="9"]',
    ),
  ].forEach((link) => new HoverImgFx9(link));
  [
    ...document.querySelectorAll(
      '[data-fx="10"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="10"]',
    ),
  ].forEach((link) => new HoverImgFx10(link));
  [
    ...document.querySelectorAll(
      '[data-fx="11"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="11"]',
    ),
  ].forEach((link) => new HoverImgFx11(link));
  [
    ...document.querySelectorAll(
      '[data-fx="12"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="12"]',
    ),
  ].forEach((link) => new HoverImgFx12(link));
  [
    ...document.querySelectorAll(
      '[data-fx="13"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="13"]',
    ),
  ].forEach((link) => new HoverImgFx13(link));
  [
    ...document.querySelectorAll(
      '[data-fx="14"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="14"]',
    ),
  ].forEach((link) => new HoverImgFx14(link));
  [
    ...document.querySelectorAll(
      '[data-fx="15"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="15"]',
    ),
  ].forEach((link) => new HoverImgFx15(link));
  [
    ...document.querySelectorAll(
      '[data-fx="16"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="16"]',
    ),
  ].forEach((link) => new HoverImgFx16(link));
  [
    ...document.querySelectorAll(
      '[data-fx="17"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="17"]',
    ),
  ].forEach((link) => new HoverImgFx17(link));
  [
    ...document.querySelectorAll(
      '[data-fx="18"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="18"]',
    ),
  ].forEach((link) => new HoverImgFx18(link));
  [
    ...document.querySelectorAll(
      '[data-fx="19"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="19"]',
    ),
  ].forEach((link) => new HoverImgFx19(link));
  [
    ...document.querySelectorAll(
      '[data-fx="20"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="20"]',
    ),
  ].forEach((link) => new HoverImgFx20(link));
  [
    ...document.querySelectorAll(
      '[data-fx="21"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="21"]',
    ),
  ].forEach((link) => new HoverImgFx21(link));
  [
    ...document.querySelectorAll(
      '[data-fx="22"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="22"]',
    ),
  ].forEach((link) => new HoverImgFx22(link));
  [
    ...document.querySelectorAll(
      '[data-fx="23"] > .rts-img-reveal-item, .rts-img-reveal-item[data-fx="23"]',
    ),
